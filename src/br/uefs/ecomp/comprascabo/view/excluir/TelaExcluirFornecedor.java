...
public class TelaExcluirFornecedor{
	...
	public TelaExcluirFornecedor(Controller controller){
		frame = new JFrame("Excluir Fornecedor");
	...
	private void prepararBotoes(){
		...
		botaoExcluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					controller.excluirFornecedor(nome);
